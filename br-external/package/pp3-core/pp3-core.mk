...
PP3_CORE_DEPENDENCIES = libntag21x libndef ncurses

define PP3_CORE_BUILD_CMDS
    $(TARGET_CXX) -L$(TARGET_DIR)/usr/lib -I$(STAGING_DIR)/usr/include -I$(STAGING_DIR)/usr/include/glib-2.0 -I$(STAGING_DIR)/usr/lib/glib-2.0/include -o $(@D)/pp3-core \
